namespace KappaUtility.Items
{
    ...
    internal class AutoTear
    {
        ...
        internal static void OnLoad()
        {
            ...
            TearMenu.Add(Player.Instance.ChampionName + "manasave", new Slider("Mana Sakla %", 85));
            TearMenu.AddSeparator();
            ...
            TearMenu.Add(Player.Instance.ChampionName + "Q", new CheckBox("Kullan Q", false));
            TearMenu.Add(Player.Instance.ChampionName + "W", new CheckBox("Kullan W", false));
            TearMenu.Add(Player.Instance.ChampionName + "E", new CheckBox("Kullan E", false));
            TearMenu.Add(Player.Instance.ChampionName + "R", new CheckBox("Kullan R", false));
            loaded = true;
        }
