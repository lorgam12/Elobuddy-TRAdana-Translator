namespace KappaUtility.Items
{
    ...
    internal class Potions
    {
        ...
        internal static void OnLoad()
        {
            ...
            PotMenu.Add("mob", new CheckBox("Minyonlar için Kullan", false));
            PotMenu.Add("jmob", new CheckBox("Orman canavalarında kullan"));
            PotMenu.Add("champ", new CheckBox("Şampiyonlarda Kullan"));
            PotMenu.Add("tower", new CheckBox("Kulelerde Kullan"));
            PotMenu.AddGroupLabel("İksir Ayarları");
            PotMenu.Add("CP", new CheckBox("Musibet İksiri", false));
            PotMenu.Add("CPH", new Slider("Canım şundan az [{0}%]", 65));
            PotMenu.Add("CPN", new Slider("Eğer daha fazla hasar geliyorsa [{0}%]", 35));
            PotMenu.Add("HP", new CheckBox("Can iksiri", false));
            PotMenu.Add("HPH", new Slider("Canım şundan az [{0}%]", 45));
            PotMenu.Add("HPN", new Slider("Eğer daha fazla hasar geliyorsa [{0}%]", 35));
            PotMenu.Add("HPS", new CheckBox("Avcı İksiri", false));
            PotMenu.Add("HPSH", new Slider("Canım şundan az [{0}%]", 75));
            PotMenu.Add("HPSN", new Slider("Eğer daha fazla hasar geliyorsa [{0}%]", 35));
            PotMenu.Add("RP", new CheckBox("Doldurulabilir İksir", false));
            PotMenu.Add("RPH", new Slider("Canım şundan az [{0}%]", 50));
            PotMenu.Add("RPN", new Slider("Eğer daha fazla hasar geliyorsa [{0}%]", 35));
            PotMenu.Add("BP", new CheckBox("Biskivi", false));
            PotMenu.Add("BPH", new Slider("Canım şundan az [{0}%]", 40));
            PotMenu.Add("BPN", new Slider("Eğer daha fazla hasar geliyorsa [{0}%]", 35));
